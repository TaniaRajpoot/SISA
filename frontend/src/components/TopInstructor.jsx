        ...
        <div className="instructors-header">
          <div className="header-left">
            ...
            <h2 className="header-title">
              Top <span className="highlight">Class</span> Instructor
            </h2>
          </div>
            ...
            >
              ...
              >
                ...
                <div className={`social-links ${hoveredShareBtn === instructor.id ? 'show' : ''}`}>
                  ...
                  <a href={instructor.socials.instagram} className="social-link" aria-label="Instagram">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                ...
                <button className="share-btn" aria-label="Share instructor">
